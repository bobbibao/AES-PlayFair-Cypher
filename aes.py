...
class AES:
    ...
    def KeyGeneration(self, password, salt):
        ...
        # Generate 2 keys: key and HMAC key
...
# a = AES('123', b'Z\x97.w/\x94\x1f\xa2G\x82\x81a\x8aGU\xe4')
# a.encrypt(b'ka\xbb\xbd\x18\xa8\x8a\x0e\xc3\x01\x00\x00\x00\x00\x00\x00')